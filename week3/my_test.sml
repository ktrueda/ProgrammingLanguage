...
val test_remove_card_4 = remove_card ([(Hearts, Ace),(Hearts, Ace)], (Hearts, Ace), IllegalMove) = [(Hearts, Ace)]
...
val test_all_same_color_3 = all_same_color [] = true
